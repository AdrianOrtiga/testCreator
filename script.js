const questionsPool = [
    ...
    {text:'Está triste porque no puede comer.', points:1, dificult: 3},
    {text:'Juan no puede comer más libros.', points:1, dificult: 3},
    {text:'Juan no puede ir a la heladería.', points:1, dificult: 3},
    {text:'David no puede jugar al fútbol.', points:1, dificult: 3},
]
...
function createNewEvaluation(difficulty){
    ...
    const allQuestions = questionsPool.filter(element => element.dificult == 0)
